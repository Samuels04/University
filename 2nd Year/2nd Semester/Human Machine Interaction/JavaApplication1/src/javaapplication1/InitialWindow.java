...
public class InitialWindow extends javax.swing.JFrame {
    ...
    public InitialWindow(MainWindow VMain){
        this();
        ...
        for(int i=1;i<=11;i=i+1){            
            java.util.TimerTask TTask=new java.util.TimerTask(){
                public void run(){InitialWindow.VInicial.timeManager();}
            };
    ...
    void timeManager(){
        ...
        if(value ==100){
            ...
            this.jLabel1.setText("Cargando: "+(value+10)+"%");
        }
    }
    private MainWindow VMain;
    static InitialWindow VInicial;
