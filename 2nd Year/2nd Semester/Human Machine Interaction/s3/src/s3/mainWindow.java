...
public class mainWindow extends javax.swing.JFrame {
    ...
    public mainWindow() {
        initComponents();
        paintPanel = (PaintPanel) CanvasPanel;
    }
    ...
    private void initComponents() {
        ...
        jMenuItem1.setText("Change colour");
    ...
    private void CanvasPanelMouseDragged(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_CanvasPanelMouseDragged
        paintPanel.setFinalPosition(evt.getX(), evt.getY());
        repaint();
    ...
    private void CanvasPanelMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_CanvasPanelMousePressed
        paintPanel.setInitialPosition(evt.getX(), evt.getY());
        paintPanel.setFinalPosition(evt.getX(), evt.getY());
        repaint();
    }//GEN-LAST:event_CanvasPanelMousePressed

    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        Color colour = JColorChooser.showDialog(null, "Choose a new colour", paintPanel.getColour());
        if(colour != null){paintPanel.setColour(colour);}
        repaint();
