...
//
// This file includes the implementation of a recursive algorithm in C to
// calculate the n-th power of a where a>=0 and n>=0
//
...
int main() {
  ...
  printf(" ---------------------------------------------\n");
  printf(" \n It is displayed the internal process: successive calls to the "
         "function, result in the base case and \n");
  printf(" partial results until the final result is achieved");
  printf("\n\n\n DESCENDING in the chain of calls ... (it is applied the "
         "SUCCESSOR FUNCTION until the base case is achieved)\n\n");
...
int POWER_details(int a, int n) {
  ...
  if (n == 0) {
    ...
    printf("\n\n ASCENDING in the chain of calls ... (it is applied the "
           "COMBINATION FUNCTION until the initial call is achieved)\n\n");
