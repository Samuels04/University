...
class Exercise2_5_3Test {
	...
	void testJeroquestValidTargets() {
		...
		for (int i = 0; i < 10; i++) {
			...
			currentGame.getBoard().movePiece(currentGame.getCharacters()[0], new Position(0, 0));
			currentGame.getBoard().movePiece(currentGame.getCharacters()[1], new Position(0, 1));
			currentGame.getBoard().movePiece(currentGame.getCharacters()[2], new Position(1, 0));
			currentGame.getBoard().movePiece(currentGame.getCharacters()[3], new Position(1, 1));
