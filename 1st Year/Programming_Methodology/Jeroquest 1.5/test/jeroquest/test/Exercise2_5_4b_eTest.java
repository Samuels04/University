 ...
 * currentGame.getBoard().movePiece(currentGame.getCharacters().get(1), new
 * Position(3, 5));
 * 
 ...
 * 
 * Dice.setSeed(0L);
 * currentGame.getCharacters().get(0).resolveTurn(); // Dwarf0 attacks to Mummy1
 * who blocks the attack
 * currentGame.getCharacters().get(1).resolveTurn(); // Dwarf1 attacks to Mummy1
 * and inflicts 1 wound
 * currentGame.getCharacters().get(2).resolveTurn(); // Globin0 attacks to
 * Dwarf0 who blocks the attack
 * currentGame.getCharacters().get(3).resolveTurn(); // Mummy1 attacks to Dwarf0
 * and inflicts 1 wound
