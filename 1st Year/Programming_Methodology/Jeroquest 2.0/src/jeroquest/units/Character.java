...
public abstract class Character implements Piece, GraphicalPiece {
	...
	private boolean violent; // the character is violent
	...
	public DynamicVectorCharacters validTargets() {
		...
		for (Character character : Controller.getInstance().getCurrentGame().getCharacters()) {
	...
	/**
	 * Is the character considered as violent by the guardians?
	 * 
	 * @return True if the character is violent
	 */
	...
	/**
	 * Setter for the violent attribute
	 * 
	 * @param violent State of violence of the character
	 */
